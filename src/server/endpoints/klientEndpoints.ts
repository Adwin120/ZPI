...
app.get('/profil/Klient/:email/usluga', authenticate, async (req: Request, res: Response) => {
    const emailParam = req.params["email"];
...
app.get('/profil//Klient/:email/wersja_umowy', authenticate, async (req: Request, res: Response) => {
    const emailParam = req.params["email"];
